...
describe 'OpenFisca mappings', ->
	it 'should properly wrap imposable', ->
		mapper.calculateNet({ imposable: 1444 }).should.eql {"scenarios":[{"test_case":{"familles":[{"parents":["ind0"]}],"foyers_fiscaux":[{"declarants":["ind0"]}],"individus":[{"activite":"Actif occupé","id":"ind0","sali":{"2015-01":1444},"type_sal":"prive_cadre"}],"menages":[{"personne_de_reference":"ind0"}]},"legislation_url":"http://api.openfisca.fr/api/1/default-legislation","period":"month:2015-01"}],"variables":["salbrut","sali","salnet","sal_h_b"]}
	...
	describe 'taille', ->
		it 'should be properly renamed', ->
			mapper.calculateFillon({ brut: 1444, taille: 15, type_sal: 'prive_cadre' }).should.eql {"scenarios":[{"test_case":{"familles":[{"parents":["ind0"]}],"foyers_fiscaux":[{"declarants":["ind0"]}],"individus":[{"activite":"Actif occupé","id":"ind0","salbrut":{"2015-01":1444},"type_sal":"prive_cadre","effectif_entreprise":15}],"menages":[{"personne_de_reference":"ind0"}]},"legislation_url":"http://api.openfisca.fr/api/1/default-legislation","period":"month:2015-01"}],"variables":["allegement_fillon"]}

	describe 'jours', ->
		it 'should be properly mapped to hours', ->
			mapper.calculateFillon({ brut: 1444, taille: 15, type_sal: 'prive_cadre', jours: 10 }).should.eql {"scenarios":[{"test_case":{"familles":[{"parents":["ind0"]}],"foyers_fiscaux":[{"declarants":["ind0"]}],"individus":[{"activite":"Actif occupé","id":"ind0","salbrut":{"2015-01":1444},"type_sal":"prive_cadre","effectif_entreprise":15,"volume_heures_remunerees":70}],"menages":[{"personne_de_reference":"ind0"}]},"legislation_url":"http://api.openfisca.fr/api/1/default-legislation","period":"month:2015-01"}],"variables":["allegement_fillon"]}

	describe 'heuresSup', ->
		it 'should be added to days', ->
			mapper.calculateFillon({ brut: 1444, taille: 15, type_sal: 'prive_cadre', jours: 10, heuresSup: 5 }).should.eql {"scenarios":[{"test_case":{"familles":[{"parents":["ind0"]}],"foyers_fiscaux":[{"declarants":["ind0"]}],"individus":[{"activite":"Actif occupé","id":"ind0","salbrut":{"2015-01":1444},"type_sal":"prive_cadre","effectif_entreprise":15,"volume_heures_remunerees":75}],"menages":[{"personne_de_reference":"ind0"}]},"legislation_url":"http://api.openfisca.fr/api/1/default-legislation","period":"month:2015-01"}],"variables":["allegement_fillon"]}

	describe 'heuresNonTravaillees', ->
		it 'should be renamed', ->
			mapper.calculateFillon({ brut: 1444, taille: 15, type_sal: 'prive_cadre', heuresNonTravaillees: 5 }).should.eql {"scenarios":[{"test_case":{"familles":[{"parents":["ind0"]}],"foyers_fiscaux":[{"declarants":["ind0"]}],"individus":[{"activite":"Actif occupé","id":"ind0","salbrut":{"2015-01":1444},"type_sal":"prive_cadre","effectif_entreprise":15,"volume_heures_non_remunerees":5}],"menages":[{"personne_de_reference":"ind0"}]},"legislation_url":"http://api.openfisca.fr/api/1/default-legislation","period":"month:2015-01"}],"variables":["allegement_fillon"]}
